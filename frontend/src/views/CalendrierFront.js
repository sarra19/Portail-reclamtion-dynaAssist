...
import CardCalendrierFrontFournisseur from "components/Cards/CardCalendrierFrontFournisseur";

export default function CalendrierFront() {
  ...
  return (
    ...
    stroke-width="4">
        ...
        <section className="relative py-16 bg-orange-dys2">
          <div className="container mx-auto px-4 bg-white">
            <div className="px-6">
             <CardCalendrierFrontFournisseur/>
            </div>
          </div>
