                    ...
                    >
                        ...
                        <div className="p-4 md:p-6">
                            ...
                            <div className="flex flex-row  gap-4 mb-6 h-64">
                                {/* Your video */}
                                <div className="flex-1 mr-4 relative bg-blueGray-100 rounded-lg overflow-hidden shadow-md">
                                    <video
                                        playsInline
                                        muted
                                        ref={userVideoRef}
                            ...
                            <div className="flex flex-wrap justify-center gap-4 mt-6">
                                <button
                                    onClick={toggleMic}
                                    className={`flex items-center  mr-2 px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300 ${
                                ...
                                <button
                                    ...
                                    className={`flex items-center px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300 ${
                            ...
                            <div className="mt-8 bg-blueGray-50 rounded-xl shadow-lg overflow-hidden">
                                <div className="p-2 bg-blueGray-800 text-white px-5 py-3 flex items-center">
                                    ...
                                    <h3 className="font-semibold">Whiteboard collaboratif</h3>
                                </div>
