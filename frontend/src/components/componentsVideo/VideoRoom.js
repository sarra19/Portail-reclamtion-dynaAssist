...
const VideoRoom = () => {
    ...
    const captureAndSendScreenshot = () => {
        ...
        html2canvas(userVideoRef.current, { useCORS: true }) 
            .then(canvas => {
                const screenshotData = canvas.toDataURL('image/png');
                console.log("Screenshot Data:", screenshotData.slice(0, 100)); 
            ...
            {!roomId ? (
                ...
                <motion.div
                    ...
                    <h2 className="text-2xl font-semibold text-center mb-6">
                        Salle ID: <span className="text-teal-500">{roomId}</span>
                    </h2>
                        ...
                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            {peers.length > 0 ? (
                                ...
                                <div className="flex items-center justify-center h-48 bg-gray-100 rounded-lg shadow-inner">
                                    <p className="text-gray-500">En attente des participants...</p>
                                </div>
                            )}
                        </div>
