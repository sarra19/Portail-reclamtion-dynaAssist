...
export interface MSSQLStoreDef {
    ...
    all(callback: (err: unknown, session?: {
    ...
    touch(sid: string, currentSession: SessionData, callback?: (err?: unknown) => void): Promise<void>;
...
declare class MSSQLStore extends ExpressSessionStore implements MSSQLStoreDef {
    table: string;
    ttl: number;
    autoRemove: boolean;
    autoRemoveInterval: number;
     ...
     * @param callback
     */
    errorHandler(method: keyof MSSQLStoreDef, error: unknown, callback?: any): any;
    /**
     ...
     */
    destroyExpired(removeCallback?: Function): Promise<void>;
    /**
     * Fetch total number of sessions
     * @param callback
     */
    length(callback: (err: unknown, length: number) => void): Promise<void>;
    /**
     * Clear all sessions
     * @param callback
     */
