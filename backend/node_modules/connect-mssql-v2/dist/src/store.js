...
class MSSQLStore extends express_session_1.Store {
    constructor(config, options) {
        ...
        this.preRemoveCallback = (options === null || options === void 0 ? void 0 : options.preRemoveCallback) || undefined;
    ...
    async all(callback) {
        try {
            ...
            callback(null, (queryResult === null || queryResult === void 0 ? void 0 : queryResult.length) ? returnObject : null);
        }
        catch (err) {
     ...
     */
    // //////////////////////////////////////////////////////////////
    async destroyExpired(removeCallback) {
        try {
